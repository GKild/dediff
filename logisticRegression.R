...
trainModel = function(refMat,classes,lengths=rep(1,nrow(refMat)),maxCells=2000,minCells=100,...){
  ##############
  # Sub-sample #
  ##############
...
predictSimilarity = function(fit,tgtData,classes=NULL,lengths=rep(1,nrow(tgtData)),minGeneMatch=0.99,logits=TRUE){
